...
const CHARLIE_DID_COMM_MESSAGING_SERVICE: ServiceEndpoint = {
  ...
  routingKeys: ["did:example:mediator2#key-x25519-1", "did:example:mediator1#key-x25519-1"],
}
...
export const CHARLIE_DID_DOC: DIDDocument = {
  ...
  verificationMethod: [CHARLIE_VERIFICATION_METHOD_KEY_AGREEM_X25519, CHARLIE_AUTH_METHOD_25519],
}
