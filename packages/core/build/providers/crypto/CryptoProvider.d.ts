...
declare type Sign = (message: Uint8Array, ...args: Args) => OrPromise<Uint8Array>;
declare type Hash = (message: Uint8Array, ...args: Args) => OrPromise<Uint8Array>;
declare type FromJwkJson<T extends KeyPair> = (jwk: Record<string, unknown>, ...args: Args) => OrPromise<T>;
declare type FromSecretBytes<T extends KeyPair> = (secretBytes: Uint8Array, ...args: Args) => OrPromise<T>;
export declare type CryptoProvider = {
    sha256?: {
        hash: Hash;
    };
    ed25519?: {
