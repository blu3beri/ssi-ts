...
export declare type VerificationMethod = {
    id: string;
    controller: string;
    type: 'JsonWebKey2020' | 'X25519KeyAgreement2019' | 'Ed25519VerificationKey2018' | 'EcdsaSecp256k1VerificationKey2019' | 'X25519KeyAgreementKey2020' | 'Ed25519VerificationKey2020';
