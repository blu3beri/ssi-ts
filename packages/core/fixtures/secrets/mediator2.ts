...
export const MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_X25519_1 = new Secret({
...
export const MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_P256_1 = new Secret({
...
export const MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_P384_1 = new Secret({
...
export const MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_P521_1 = new Secret({
...
export const MEDIATOR2_SECRETS: Array<Secret> = [
